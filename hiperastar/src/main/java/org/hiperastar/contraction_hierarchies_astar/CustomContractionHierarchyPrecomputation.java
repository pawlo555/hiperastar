 ...
 */
public class CustomContractionHierarchyPrecomputation<V, E>
{
    /**
     ...
     */
    public CustomContractionHierarchyPrecomputation(Graph<V, E> graph, ThreadPoolExecutor executor)
    {
     ...
     * @param executor executor which will be used for parallelization
     */
    public CustomContractionHierarchyPrecomputation(
